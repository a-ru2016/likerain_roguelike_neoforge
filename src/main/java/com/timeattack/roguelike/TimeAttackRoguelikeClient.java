...
import com.timeattack.roguelike.gui.StartGameScreen;
...
@EventBusSubscriber(modid="timeattackroguelike", bus=EventBusSubscriber.Bus.MOD, value={Dist.CLIENT})
public class TimeAttackRoguelikeClient {
    public static KeyMapping openCarryoverKey;

    @SubscribeEvent
    public static void onRegisterMenuScreens(RegisterMenuScreensEvent event) {
        event.register((MenuType)TimeAttackRoguelike.CARRYOVER_SCREEN_HANDLER.get(), CarryoverSelectScreen::new);
    }

    @SubscribeEvent
    public static void onRegisterKeyMappings(RegisterKeyMappingsEvent event) {
        openCarryoverKey = new KeyMapping("key.timeattackroguelike.open_carryover", InputConstants.Type.KEYSYM, 79, "category.timeattackroguelike.keys");
